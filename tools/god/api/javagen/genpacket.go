...
import com.god.commons.JSON;
import com.god.commons.JsonParser;
import com.god.core.network.HttpRequestClient;
import com.god.core.packet.HttpRequestPacket;
import com.god.core.response.HttpResponseData;
	...
	for _, at := range allTypes {
		for _, item := range sharedTypes {
			if item.Name == at.Name {
				fmt.Fprintf(&builder, "import com.god.logic.http.packet.%s.model.%s;\n", packetName, item.Name)
				break
			}
		}
	}
