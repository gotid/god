...
func TestAdaptiveShedder(t *testing.T) {
	DisableLog()
	shedder := NewAdaptiveShedder(WithWindow(bucketDuration), WithBuckets(buckets), WithCpuThreshold(1))
...
func TestAdaptiveShedder_MaxPass(t *testing.T) {
...
func TestAdaptiveShedder_MinRt(t *testing.T) {
...
func TestAdaptiveShedder_MaxFlight(t *testing.T) {
	passCounter := newRollingWindow()
	rtCounter := newRollingWindow()
	for i := 0; i < 10; i++ {
		if i > 0 {
...
func TestAdaptiveShedder_ShouldDrop(t *testing.T) {
	logx.Disable()
	passCounter := newRollingWindow()
	rtCounter := newRollingWindow()
	for i := 0; i < 10; i++ {
...
func TestAdaptiveShedder_StillHot(t *testing.T) {
	logx.Disable()
	passCounter := newRollingWindow()
	rtCounter := newRollingWindow()
	for i := 0; i < 10; i++ {
	...
	shedder.overloadTime.Set(-coolOfDuration * 2)
	assert.False(t, shedder.stillHot())
