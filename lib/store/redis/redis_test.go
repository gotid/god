...
func TestRedis_GetSet(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		_, err := New(client.Addr, badType()).GetSet("hellox", "world")
		assert.NotNil(t, err)
...
func TestRedis_SetGetDel(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		err := New(client.Addr, badType()).Set("hellox", "world")
		assert.NotNil(t, err)
		err = client.Set("hellox", "world")
		assert.Nil(t, err)
		_, err = New(client.Addr, badType()).Get("hellox")
		assert.NotNil(t, err)
		val, err := client.Get("hellox")
		assert.Nil(t, err)
		assert.Equal(t, "world", val)
...
func TestRedis_SetExNx(t *testing.T) {
	runOnRedis(t, func(client *Redis) {
		err := New(client.Addr, badType()).SetEx("hellox", "world", 5)
		assert.NotNil(t, err)
		err = client.SetEx("hellox", "world", 5)
		assert.Nil(t, err)
		_, err = New(client.Addr, badType()).SetNX("hellox", "newworld")
		assert.NotNil(t, err)
