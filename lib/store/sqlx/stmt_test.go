...
func (m *mockedSessionConn) ExecContext(_ context.Context, _ string, _ ...interface{}) (sql.Result, error) {
	if m.delay {
...
func (m *mockedSessionConn) QueryContext(_ context.Context, _ string, _ ...interface{}) (*sql.Rows, error) {
	if m.delay {
		time.Sleep(defaultSlowThreshold + time.Millisecond)
	}
