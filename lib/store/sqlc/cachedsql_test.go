...
func TestStat(t *testing.T) {
	...
	for i := 0; i < 10; i++ {
		var str string
		err = c.QueryRow(&str, "name", func(conn sqlx.Conn, v interface{}) error {
			*v.(*string) = "designer"
			return nil
		})
		if err != nil {
...
func TestCachedConn_QueryRowIndex_NoCache(t *testing.T) {
	...
	}, func(conn sqlx.Conn, v interface{}) (interface{}, error) {
		*v.(*string) = "designer"
		return "primary", errors.New("foo")
	}, func(conn sqlx.Conn, v, pri interface{}) error {
...
func TestCachedConnQueryRow(t *testing.T) {
	...
	err = c.QueryRow(&user, key, func(conn sqlx.Conn, v interface{}) error {
		ran = true
		user = value
		return nil
	})
