...
// UnmarshalKey 根据 key 解组键值对字典 m 至 v。
...
func (u *Unmarshaler) processFieldPrimitiveWithJSONNumber(fieldType reflect.Type, value reflect.Value,
	...
	case reflect.Uint, reflect.Uint8, reflect.Uint16, reflect.Uint32, reflect.Uint64:
		...
		if iValue < 0 {
			return fmt.Errorf("解编组 %q 使用了错误的值 %q", fullName, v.String())
		}
...
func (u *Unmarshaler) processNamedFieldWithValue(fieldType reflect.Type, value reflect.Value,
	...
	if mapValue == nil {
		...
		return fmt.Errorf("字段 %s 不能为空", key)
	}
...
func (u *Unmarshaler) processNamedFieldWithoutValue(fieldType reflect.Type, value reflect.Value, opts *fieldOptionsWithContext, fullName string) error {
