...
// NewRequestParser 从给定的 http.Request 和 jsonpb.AnyResolver 中创建一个新的 grpcurl.RequestParser。
...
func buildJsonRequestParser(m map[string]interface{}, resolver jsonpb.AnyResolver) (grpcurl.RequestParser, error) {
