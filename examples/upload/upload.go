...
import (
	...
	"github.com/gotid/god/examples/upload/internal/config"
	"github.com/gotid/god/examples/upload/internal/handler"
...
var configFile = flag.String("f", "etc/upload-api.yaml", "配置文件")
