...
import (
	...
	"github.com/gotid/god/examples/http/jwt/internal/config"
	"github.com/gotid/god/examples/http/jwt/internal/handler"
	"github.com/gotid/god/examples/http/jwt/internal/svc"
	"github.com/gotid/god/lib/conf"
)

var configFile = flag.String("f", "etc/jwt-api.yaml", "配置文件")
