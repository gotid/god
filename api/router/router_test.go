...
func TestParseJsonPost(t *testing.T) {
	...
	assert.Equal(t, "richard:2020:whatever:200000:shanghai:20170912", rr.Body.String())
}
...
func TestParsePath(t *testing.T) {
	r, err := http.NewRequest(http.MethodGet, "http://hello.com/richard/2020", nil)
	assert.Nil(t, err)
	...
	assert.Equal(t, "richard in 2020", rr.Body.String())
}

func TestParsePathRequired(t *testing.T) {
	r, err := http.NewRequest(http.MethodGet, "http://hello.com/richard", nil)
	assert.Nil(t, err)
...
func TestParseQueryRequired(t *testing.T) {
	r, err := http.NewRequest(http.MethodPost, "http://hello.com/richard/2020?nickname=whatever", nil)
	assert.Nil(t, err)
...
func TestParseOptional(t *testing.T) {
	r, err := http.NewRequest(http.MethodGet, "http://hello.com/richard/2020?nickname=whatever&zipcode=", nil)
	assert.Nil(t, err)
...
func TestParseNestedInRequestEmpty(t *testing.T) {
	r, err := http.NewRequest(http.MethodPost, "http://hello.com/richard/2020", bytes.NewBufferString("{}"))
	assert.Nil(t, err)
	...
	assert.Equal(t, "richard:2020", rr.Body.String())
}
...
func TestParsePtrInRequest(t *testing.T) {
	...
	assert.Equal(t, "richard:2020:100", rr.Body.String())
}

func TestParsePtrInRequestEmpty(t *testing.T) {
	r, err := http.NewRequest(http.MethodPost, "http://hello.com/richard", bytes.NewBufferString("{}"))
	assert.Nil(t, err)
	...
	router := NewRouter()
	err = router.Handle(http.MethodPost, "/richard", http.HandlerFunc(
		func(w http.ResponseWriter, r *http.Request) {
			var v WrappedRequest
			err = httpx.Parse(r, &v)
			assert.Nil(t, err)
...
func TestParse(t *testing.T) {
	...
	assert.Equal(t, "richard:2020:whatever:200000", rr.Body.String())
}
...
func TestParseWrappedHeadRequestWithJsonHeader(t *testing.T) {
	r, err := http.NewRequest(http.MethodHead, "http://hello.com/richard/2020", nil)
	assert.Nil(t, err)
	r.Header.Set(httpx.ContentType, applicationJsonWithUtf8)
...
func TestParseWithMissingForm(t *testing.T) {
	r, err := http.NewRequest(http.MethodPost, "http://hello.com/richard/2020?nickname=whatever",
		bytes.NewBufferString(`{"location": "shanghai", "time": 20170912}`))
	assert.Nil(t, err)
...
func TestParseWithMissingPath(t *testing.T) {
	r, err := http.NewRequest(http.MethodPost, "http://hello.com/2020?nickname=whatever&zipcode=200000",
		bytes.NewBufferString(`{"location": "shanghai", "time": 20170912}`))
	assert.Nil(t, err)
...
func TestParseJsonPostWithInt2String(t *testing.T) {
	r, err := http.NewRequest(http.MethodPost, "http://hello.com/richard/2020",
		bytes.NewBufferString(`{"time": 20201122}`))
	assert.Nil(t, err)
	r.Header.Set(httpx.ContentType, applicationJsonWithUtf8)
