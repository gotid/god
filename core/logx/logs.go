...
func slowFieldsSync(msg string, fields ...LogField) {
	if shallLog(ErrorLevel) {
		getWriter().Slow(msg, fields...)
	}
}
...
func errorFieldsSync(msg string, fields ...LogField) {
	if shallLog(ErrorLevel) {
...
func infoFieldsSync(msg string, fields ...LogField) {
	if shallLog(InfoLevel) {
		getWriter().Info(msg, fields...)
	}
}

func infoAnySync(v interface{}) {
	if shallLog(InfoLevel) {
		getWriter().Info(v)
	}
}
